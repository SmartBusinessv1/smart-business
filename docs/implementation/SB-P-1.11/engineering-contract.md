...
| 9A. Founder Workflow Reconciliation (FWR-001–005) | §8 "CSV and Excel Bulk Import", "SKU" | D-023 (reconciled, not amended), D-047, D-053–D-058, D-068 | — (Founder Workflow Reconciliation Record) |
