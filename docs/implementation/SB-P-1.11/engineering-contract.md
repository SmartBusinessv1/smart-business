...
| Founder Product Decision Record | `docs/phase-1-mission-blueprint/completed/SB-P-1.11-Founder-Product-Decision-Record.md` — D-001 through D-068 |
...
4. SB-P-1.11 Product Blueprint, Sections 1–21, LOCKED (`docs/phase-1-mission-blueprint/completed/SB-P-1.11.md`).
