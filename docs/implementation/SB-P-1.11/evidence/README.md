...
- **Locked Bulk-Import EIS (Build Now Gap Closure):** [`docs/phase-1-mission-blueprint/completed/SB-P-1.11-Build-Now-Gap-Closure-EIS.md`](../../../phase-1-mission-blueprint/completed/SB-P-1.11-Build-Now-Gap-Closure-EIS.md) — Part A locks the CSV/XLSX bulk-import upload/preview/commit flow; this is the authority chain the `catalog_import_batches`/`catalog_import_rows` schema (GC-40 Migration 1) and the GC-38R Lambda Parser support schema (GC-40 Migrations 3–4) implement.
