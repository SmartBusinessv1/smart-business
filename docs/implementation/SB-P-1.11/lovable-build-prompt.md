...
4. **SB-P-1.11 Product Blueprint** (`docs/phase-1-mission-blueprint/completed/SB-P-1.11.md`), Sections 1–21, LOCKED — Product Truth, merchant behaviour, scope, exclusions, approved sequencing.
5. **SB-P-1.11 Founder Decisions D-001 through D-068** (`docs/phase-1-mission-blueprint/completed/SB-P-1.11-Founder-Product-Decision-Record.md`).
