...
**Operational baseline revision:** amendment proposed on 2026-09-19 under `SB-GOV-PRODUCT-EXEC-1.0`, independently verified and merged in PR #606 (publication commit `b3cd5f439e8795855d6ef0f527d7ccea18c48080`). It is operative from the activation event, the human merge of the finalization pull request identified in Section 8.1 of the [activation record](../../../communication/missions/SB-GOV-PRODUCT-EXEC-1.0/mission-control/04_activation_decision_and_metadata_reconciliation.md), at its actual `merged_at` UTC instant; until then the operational baseline is this plan as it stood at commit `c3ef55fe0cf94f4491cb2ae257b084f90b49b40b`. The build direction, the nine-mission sequence, the product outcomes, the Founder runtime scenarios and the unresolved Founder decisions are unchanged. Only the operational baseline and the mission-level coverage rules below are revised.
...
- **Verification protocol.** The Independent Verification Efficiency Protocol (`SB-IV-1.0`) is active at Version 1.0 until the activation event of `SB-GOV-PRODUCT-EXEC-1.0` and at Version 1.1 from it. Version 1.1 was independently verified and merged in PR #606.
