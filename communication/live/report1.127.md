...
- §14 "Backend Schema/Function/Role/Grant": corrected CHK-BE-004's Phase 2b row and total command count (28 → 25), with an explicit note that only the Phase 2b row was reconciled and the Phase 1/Phase 3/scheduler rows were not independently audited by this mission; corrected CHK-P2A-002's "28-command list" cross-reference.
