...
- **Activation Date:** 2026-08-01 (Version 1.0). Version 1.1: PENDING — the `merged_at` UTC date of the finalization pull request, recorded afterward as mandatory factual evidence
- **Activation Commit:** `6971a661c5b43858f424804af3f1c8e23c1eae7e` (Version 1.0). Version 1.1: PENDING — the merge commit of the finalization pull request, recorded afterward as mandatory factual evidence
