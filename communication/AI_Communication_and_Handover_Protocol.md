...
- **Activated By:** Mission Control (Version 1.0). Version 1.1: Mission Control, by the conditional Section 8.1 decision of the activation record, effective only on the human merge of the finalization pull request
- **Activation Date:** 2026-08-01 (Version 1.0). Version 1.1: 2026-09-20T11:34:43Z UTC (2026-09-20 17:04:43 IST), the actual GitHub `merged_at` instant of the human merge of the finalization pull request (PR #608), recorded afterward as mandatory factual evidence
- **Activation Commit:** `6971a661c5b43858f424804af3f1c8e23c1eae7e` (Version 1.0). Version 1.1: `abc458dff590accbc9454367728978553bd3a25b`, the merge commit of the finalization pull request (PR #608), recorded afterward as mandatory factual evidence
...
**Interpretation note (finalization reconciliation, `SB-GOV-PRODUCT-EXEC-1.0`).** The Status of row 1.1 and the header Status previously read "AMENDMENT MERGED (PR #606) — MISSION CONTROL ACTIVATION CONFIRMATION PENDING". They now record that Version 1.1 is active from the activation event, the human merge of the finalization pull request. The header Activated By for Version 1.1, previously "PENDING", now records the conditional Mission Control decision. The Activation Date and Activation Commit for Version 1.1 remain PENDING as mandatory post-merge factual evidence. The Status of row 1.0 remains as logged (`ACTIVE`), and Version 1.0 is superseded by Version 1.1 at the activation event. No activation date, activation commit or activation merge commit is recorded.

**Interpretation note (post-activation factual reconciliation, `SB-GOV-PRODUCT-EXEC-1.0`).** The post-activation evidence pull request recorded the activation facts that the finalization pull request had reserved. The header Activation Date for Version 1.1, previously "PENDING — the `merged_at` UTC date of the finalization pull request, recorded afterward as mandatory factual evidence", now records 2026-09-20T11:34:43Z. The header Activation Commit, previously "PENDING — the merge commit of the finalization pull request, recorded afterward as mandatory factual evidence", now records the PR #608 merge commit `abc458dff590accbc9454367728978553bd3a25b`. The row 1.1 Status previously ended "No activation date, activation commit or activation merge commit is recorded here; they are recorded afterward as mandatory factual evidence". This reconciliation is mandatory evidence and is not a second activation event. Version 1.1 became active at the human merge of PR #608 at `merged_at` 2026-09-20T11:34:43Z, and that instant is unchanged. The Version 1.0 activation commit, the PR #606 publication commit and the PR #607 preparation commit are unchanged and are not the Version 1.1 activation commit.

---

**Activation control:** Version 1.1 is an amendment under `SB-GOV-PRODUCT-EXEC-1.0`. It has been independently verified and human-merged (PR #606) and is active from the activation event, the human merge of the finalization pull request defined in the Source 18 header; Version 1.0 remains operative until then. Stage A and Stage B are active under independently verified technical branch protection. The temporary Phase 1 compensating control was retired on 2026-08-02. Communication-governance activation completed and its communication record was authorized for closure and archive on 2026-08-01.
