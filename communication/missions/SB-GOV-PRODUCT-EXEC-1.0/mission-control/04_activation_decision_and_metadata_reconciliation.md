...
| Finalization pull request number | `NOT YET RECORDED`. The draft pull request is not open when this text is committed, and a factual follow-up commit records the number |
