...
| AC-02 | Ten non-backup EOS architecture/governance documents under `docs/engineering/eos/` | Draft; Founder approval pending | Decide per-document approval/publication | Founder with Mission Control review | Backup separation COMPLETE on 2026-08-03; focused EOS authority review remains | Keep Pending pending focused review | Medium engineering-policy ambiguity |
