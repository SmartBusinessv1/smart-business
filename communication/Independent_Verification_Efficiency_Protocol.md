...
- **Status:** `ACTIVE` (Version 1.0). Version 1.1: `AMENDMENT MERGED (PR #606) — MISSION CONTROL ACTIVATION CONFIRMATION PENDING`. Version 1.0 remains the operative text until Mission Control records the Activation Confirmation (the post-merge activation step defined in the Source 18 header and recorded in the [activation record](missions/SB-GOV-PRODUCT-EXEC-1.0/mission-control/04_activation_decision_and_metadata_reconciliation.md)). Version 1.1 has been independently verified and merged by a human
- **Activation Authority:** Smart Business Mission Control
- **Activation Date:** 2026-09-18 (Version 1.0). Version 1.1: PENDING — set only by the Mission Control Activation Confirmation
- **Activation Basis:** PR #598 merge commit `4ddbb647cfb413e43af38a7e362130c5fd16133c` (Version 1.0), activated in PR #599. Version 1.1: PENDING. PR #606 publication commit `b3cd5f439e8795855d6ef0f527d7ccea18c48080` is a publication commit and not an activation basis
...
| 1.1 | 2026-09-19 | Amendment under `SB-GOV-PRODUCT-EXEC-1.0`, limited to: FCTM and source-contract completeness, classification and mission-assignment integrity, and material drift verification (Sections 3 to 8 and 13); a mandatory human retest after every correction (Section 9); this version history; and conforming references to Source 18 Version 1.2. The Protocol ID `SB-IV-1.0` is unchanged. No new verifier authority | Founder scope approval, PR #605 comment `5742411779`; Founder human merge of PR #606 | AMENDMENT MERGED (PR #606) — MISSION CONTROL ACTIVATION CONFIRMATION PENDING. Independently verified and merged at publication commit `b3cd5f439e8795855d6ef0f527d7ccea18c48080` (publication commit, not an activation commit). No activation date or activation merge commit is recorded here; the Activation Confirmation records them |
