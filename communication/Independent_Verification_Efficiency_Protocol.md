...
- **Activation Date:** 2026-09-18 (Version 1.0). Version 1.1: 2026-09-20T11:34:43Z UTC (2026-09-20 17:04:43 IST), the actual GitHub `merged_at` instant of the human merge of the finalization pull request (PR #608) defined in the Source 18 header, recorded afterward as mandatory factual evidence
- **Activation Basis:** PR #598 merge commit `4ddbb647cfb413e43af38a7e362130c5fd16133c` (Version 1.0), activated in PR #599. Version 1.1: PR #608 merge commit `abc458dff590accbc9454367728978553bd3a25b`, the human merge of the finalization pull request, recorded afterward as mandatory factual evidence. PR #606 publication commit `b3cd5f439e8795855d6ef0f527d7ccea18c48080` is a publication commit and PR #607 preparation merge commit `86d9813582c4505c41be2c712a2a1df33912e988` is a preparation commit. Neither is an activation basis
...
**Interpretation note (post-activation factual reconciliation, `SB-GOV-PRODUCT-EXEC-1.0`).** The post-activation evidence pull request recorded the activation facts that the finalization pull request had reserved. The Version 1.1 Activation Date, previously "PENDING — the `merged_at` UTC date of the finalization pull request defined in the Source 18 header, recorded afterward as mandatory factual evidence", now records 2026-09-20T11:34:43Z. The Version 1.1 Activation Basis, previously "PENDING — the merge commit of the finalization pull request, recorded afterward as mandatory factual evidence", now records the PR #608 merge commit `abc458dff590accbc9454367728978553bd3a25b`. The row 1.1 Status previously ended "No activation date or activation merge commit is recorded here; they are recorded afterward as mandatory factual evidence". This reconciliation is mandatory evidence and is not a second activation event. Version 1.1 became active at the human merge of PR #608 at `merged_at` 2026-09-20T11:34:43Z, and that instant is unchanged. The protocol ID `SB-IV-1.0` and the Version 1.0 values are unchanged.
