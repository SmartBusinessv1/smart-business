...
- **Source:** 18
- **Version:** 1.2
- **Status:** v1.2 ACTIVE — AUTHORITATIVE FROM THE ACTIVATION EVENT: the human merge of the finalization pull request, at its actual `merged_at` UTC instant. v1.1 is operative until that event
- **Authority:** FOUNDER APPROVED — AUTHORITATIVE (v1.1 until the activation event; v1.2 from it). The v1.2 amendment is not authoritative before the activation event
- **Approved By:** Founder — Riyas PK (v1.0 on 2026-08-01; v1.1 on 2026-09-18). v1.2: Founder — Riyas PK, by the decisions recorded on PR #605 and the human merge of PR #606 (evidence: activation record, Section 3)
- **Approval Date:** v1.1: 2026-09-18. v1.2: 2026-09-19 (UTC), the date of those decisions and of the PR #606 merge
- **Activated By:** v1.1: Smart Business Mission Control. v1.2: Smart Business Mission Control, by the conditional Section 8.1 decision in the finalization pull request defined below, effective only on its human merge
- **Activation Date:** v1.1: 2026-09-18. v1.2: 2026-09-20T11:34:43Z UTC (2026-09-20 17:04:43 IST), the actual GitHub `merged_at` instant of the human merge of the finalization pull request (PR #608), recorded afterward as mandatory factual evidence
- **Repository publication:** v1.0 publication complete at historical commit `bd9b362`; v1.1 amendment/publication merged in PR #598 at `4ddbb647cfb413e43af38a7e362130c5fd16133c` and activated in PR #599; v1.2 amendment independently verified and merged by a human in PR #606 at publication commit `b3cd5f439e8795855d6ef0f527d7ccea18c48080` (final reviewed head `7e47118ccf039210803d22646843dd16088aa190`, merged 2026-09-19T19:37:16Z UTC). That commit is a publication commit and not an activation commit. The activation-record pull request (PR #607) was merged by a human at preparation commit `86d9813582c4505c41be2c712a2a1df33912e988` (final reviewed head `71745adc2152cea49b4d1432fbc6d4d62ac08f2f`, merged 2026-09-20T10:18:47Z UTC), which is a preparation commit and not an activation commit. The finalization pull request (PR #608) was merged by a human at activation merge commit `abc458dff590accbc9454367728978553bd3a25b` (final reviewed head `4419927682d0ebb63da05156ba1e5ba08e1f5da7`, `merged_at` 2026-09-20T11:34:43Z UTC, which is 2026-09-20 17:04:43 IST). That merge is the activation event. Its merge commit and instant are recorded here afterward as mandatory factual evidence, and that recording is not a second activation event
...
> **Authority notice:** This v1.2 amendment implements the Founder decisions recorded on PR #605 (comments `5740893113`, `5740990250`, `5741014275` and `5742411779`) and Mission Control's amendment-scope review (comment `5742307415`). It has been independently verified, reviewed by Mission Control and merged by a human in PR #606. **It is not active until the activation event defined below, the human merge that puts Mission Control's Activation Confirmation on canonical `main`.** Until that event, no Product Mission may rely on the amended clauses, and the operative text is Source 18 v1.1 as it stood at commit `c3ef55fe0cf94f4491cb2ae257b084f90b49b40b`. From that event, v1.2 is authoritative for all `SB-P-*` mission lifecycle and delivery work. It remains subordinate to the Lighthouse Constitution, Smart Business constitutional authority, and the approved governance order.
>
> **Activation boundary and post-merge step.** Human merge of this amendment in PR #606 does not activate it. Activation is a distinct step of Mission Control after that merge, and it has exactly one activation event, defined below. Until that event, the operative texts are Source 18 Version 1.1, the Elaboration template Version 1.3, the Implementation and Evidence template Version 1.1, the Communication and Handover Protocol Version 1.0 and the Independent Verification Efficiency Protocol Version 1.0, each as it stood at commit `c3ef55fe0cf94f4491cb2ae257b084f90b49b40b`.
>
> **The two pull requests.** The **activation-record pull request** is PR #607, from branch `mission/SB-GOV-PRODUCT-EXEC-1.0-activation-record`. It prepares the [activation record](../../communication/missions/SB-GOV-PRODUCT-EXEC-1.0/mission-control/04_activation_decision_and_metadata_reconciliation.md) and the conditional status wording of the amended files. It is preparation only, and neither its publication nor its merge activates any clause. The **finalization pull request** is a later and separate pull request, from branch `mission/SB-GOV-PRODUCT-EXEC-1.0-finalization` and identified in Section 8.1 of the activation record. It is authorized, independently verified and reviewed by Mission Control separately from PR #607, and it carries Mission Control's completed Section 8 decision.
>
> **Activation Confirmation and activation event.** The Activation Confirmation is Mission Control's completed Section 8.1 decision in the finalization pull request. It is conditional until an authorized human merges that pull request into canonical `main`. That merge is the single activation event, and the effective time is the actual `merged_at` UTC instant that GitHub records for it. It activates the five amended instruments together and none of them separately. Nothing else activates any clause: not the merge of PR #606; not the opening, verification, review or merge of PR #607; not the opening, authoring, approval, verification or review of the finalization pull request before it is merged; not a dated comment; and not any statement of intent.
>
> **Completed before the activation event.** The following are complete before the finalization pull request is merged: (a) PR #607 independently verified, reviewed by Mission Control and merged by a human, and Mission Control's verification of the resulting canonical `main`; (b) Mission Control's completed Section 8.1 decision; (c) the independent verification of the finalization pull request and Mission Control's review of it; and (d) in the finalization pull request, the prospective text for the six items that follow, each taking effect only on its merge: (1) the activation authority; (2) Status and Activated By in this header and in the Source Change Log; (3) the same reconciliation in every other amended file that carries a pending status, which are the Elaboration and the Implementation and Evidence templates, the AI Communication and Handover Protocol and the Independent Verification Efficiency Protocol; (4) the pending and conditional wording in `AGENTS.md`, `communication/README.md` and the Canonical Source Set converted into unconditional text; (5) the Source Set register row for this file, computed from this file as stored in Git in the finalization pull request; and (6) the Project HQ synchronization status.
>
> **Mandatory evidence after the activation event.** The actual merge commit and `merged_at` instant do not exist before the merge, so this amendment, PR #607 and the finalization pull request do not pre-write them. They are recorded afterward, in an append-only reconciliation: in Section 8.2 of the activation record and in the Activation Date and merge-commit fields of this header, this Source Change Log and the other amended files. This file's byte count and SHA-256 are recomputed in the Source Set register row and re-verified against `main`. The reconciliation is mandatory and is part of the audited evidence of the activation. It is not optional, it is not a second activation event or gate, it does not delay activation and it does not change the effective instant. Mission Control's verification and report of the finalization merge are evidence in the same way and are not a condition of activation. Until the reconciliation is complete, an Activation Date or merge-commit field that reads `PENDING` does not condition the effect.
...
6. **Completeness test.** It is objective and set-based, and it compares the matrix with the source text and not only with itself: (a) every numbered section of every in-scope contract is represented by at least one row; (b) every applicable, separately verifiable obligation inside an in-scope, partially delivered or mixed section is represented by its own row, and inside a wholly non-`IN SCOPE` section by the single section-level row that item 2 permits; (c) every numbered acceptance scenario is individually represented by its own row; (d) every row has exactly one disposition with a citation, and at lock there is no `ESCALATED` row and no critical-path `UNRESOLVED FOUNDER DECISION` row, and each row's classification and assignment equal the source text; (e) at every later gate, every `IN SCOPE` row is mapped downstream and no downstream item is an orphan. Checks (a) to (c) are made against an **obligation inventory taken from the source text** and independent of the matrix: the inventory is a list of pointers to the numbered sections, obligations and acceptance scenarios of each in-scope contract at the intake baseline, kept in the verification record, and it is not a second matrix and restates no requirement. The Definition Actor prepares it while populating the matrix, Mission Control tests it against the source text at Stages 5 and 8 and repeats checks (d) and (e) at Stages 10, 11 and 13, and the Stage 19 verifier takes its own inventory without relying on the Definition Actor's. **A missing obligation or acceptance scenario fails the test even when every retained row has a valid disposition and a consistent downstream mapping.** For example, if a contract's acceptance-scenario section is represented by a row for one scenario while a separate scenario in the same section has no row, check (c) fails, although the section is represented and every retained row maps downstream. This is a verification-method rule against the existing approved contracts and adds no product requirement.
...
11. **Verification.** The Stage 19 verifier checks material coverage and drift as Stage 19 requires. The Completion Report carries a Contract Reconciliation whose statuses are `DEMONSTRATED`, `DEMONSTRATED — CARRIED FORWARD`, `IMPLEMENTED — NOT DEMONSTRATED`, `PARTIALLY DEMONSTRATED`, `NOT IMPLEMENTED`, `ASSIGNED TO LATER MISSION`, `DELEGATED`, `OUT OF BUILD SCOPE`, `NOT APPLICABLE` and `DEFERRED WITH FOUNDER DECISION <ID>`. A row without evidence is not demonstrated, and absence of failure is not `PASS`. The Contract Reconciliation is compiled at Stage 22, after Stage 19, and is checked by the Reconciliation Integrity Check that follows Stage 22, which never replaces Stage 19.
...
| Evidence and Completion compiler | 21 and 22 | Claude Code, unless Mission Control appoints another actor, under a **separate appointment made after independent verification** | A role separate from any builder role. The compiler records the verifier's findings by reference and never edits, summarizes away or suppresses them, and never gives a row a status better than its Stage 19 result. Mission Control reviews the package and runs the Reconciliation Integrity Check. Where the actor that built a workstream would also compile that workstream's reconciliation lines, Mission Control appoints a different compiler for those lines; if no eligible different compiler exists, the conflict is flagged and escalated to the Founder and is not resolved by loosening separation |
| Acceptance | 23 | Mission Control, with the Founder where required | Unchanged |

### 4.4 Claude Code

Claude Code owns Builder Review, Engineering Review, Product Blueprint Sections 20–21, the post-lock EIS, the initial implementation package, repository verification, stage reports, and Founder Briefs assigned to its stages. Claude Code also owns the Evidence Package and the formal Completion Report, but only as the Evidence and Completion compiler under the separate appointment of Section 4.3, made after independent verification. Claude Code may own independent post-build verification only when appointed under Section 4.9 and independent of the implementation and corrections being verified. Claude Code may be appointed Definition Actor where fit and may be an authorized builder where the Implementation Authorization names it, subject to the role-separation rule of Section 4.3 and the independence rules of Section 4.9. Acting as an authorized builder and acting as Evidence and Completion compiler are separate roles: as a builder it cannot verify, approve or accept its own work, and in neither role may it alter, summarize away or suppress an independent finding.
...
**Successive roles.** The prohibition on creating the formal Completion Report binds an actor in its builder role. An actor that built a workstream, including Claude Code, may later act as Evidence and Completion compiler only under the separate appointment and the safeguards of Section 4.3, made after independent verification, and never as part of its builder role. Independent verification and Mission Control acceptance remain separate from both roles, and neither role changes an artifact name.
...
**Coverage and drift, for every Product Mission whatever the Codex utilization classification.** The verifier records independence and does not implement corrections. It (1) takes an independent obligation inventory of each in-scope contract from the source text, meaning its numbered sections, its applicable obligations and each numbered acceptance scenario, and compares it with the FCTM, so that an obligation or acceptance scenario with no row, and no permitted section-level row, is a coverage failure (`SILENT OMISSION`) even when every retained row maps consistently downstream (coverage completeness); (2) compares each row's disposition, build commitment, commercial classification and mission assignment in the locked FCTM at Stage 8 and the Stage 13 mappings, and the builder's draft row statuses, with the source text and the Founder Decision IDs (movement integrity); and (3) compares implemented behaviour with the approved expected experience, permissions, denial behaviour and business rules, by direct probing for material rows and by other evidence otherwise (drift). Findings named `SILENT OMISSION`, `UNAUTHORIZED DEFERRAL`, `UNAUTHORIZED PULL-FORWARD`, `MISCLASSIFIED`, `DRIFT` and `ORPHAN` map onto `PASS`, `FAIL`, `FOLLOW-UP` and `NOT APPLICABLE`. A material coverage or drift `FAIL` is a material blocking failure. The verifier reports and never decides Product Truth. Where the only eligible verifier authored the FCTM, Mission Control records a separation assessment and the check is made against the source contracts.

**Stage 19 verifies only against evidence that exists at Stage 19:** the source contracts, the locked FCTM, the Stage 13 mappings, the Builder Completion Report and Verification Packet with the builder's draft row statuses, the human runtime findings, the repository and the tests. It does not review or certify the Stage 22 Contract Reconciliation, which does not yet exist. That reconciliation is checked afterwards by the Reconciliation Integrity Check (Stage 22), which never waives, replaces or shortens Stage 19.
...
- **Owner:** The Evidence and Completion compiler appointed by Mission Control after independent verification (Section 4.3): Claude Code unless another actor is appointed.
...
- **Owner:** The Evidence and Completion compiler appointed by Mission Control after independent verification (Section 4.3): Claude Code unless another actor is appointed. The compiler records independent findings by reference and does not edit them.
...
**Reconciliation Integrity Check (after Stage 22 and before Stage 23).** The check is separate from Stage 19 and does not waive it.

- *Responsible actor:* Mission Control. Mission Control may refer a narrow, finding-scoped question to the Independent Verification Actor only where the reconciliation shows a substantive change since Stage 19 or a new risk. The referral never reopens or replaces Stage 19.
- *Inputs:* the Stage 22 Completion Report with its Contract Reconciliation and Experience Verification Matrix; the locked FCTM and the Stage 13 mappings; the Stage 19 verification report with its per-row results; the Builder Completion Report; the human runtime findings; and the Founder Product Decision Records.
- *Checks:* every FCTM row appears exactly once with one status of the Section 3.2 vocabulary; every `DEMONSTRATED` row cites verified evidence, meaning a Stage 19 result of `PASS` for that row or carried-forward evidence that passed its impact check; no row status is better than its Stage 19 result, and no verifier finding is edited, summarized away or omitted; no disposition, build commitment, commercial classification or mission assignment differs from the lock without a cited Founder Decision ID; the per-contract lists of `BUILD NOW` requirements not demonstrated are complete and their counts agree; and the Experience Verification Matrix cites the same row IDs.
- *Evidence:* Mission Control records each check and any discrepancy in the Stage 23 acceptance record.
- *Escalation:* a discrepancy returns the reconciliation to its compiler for correction and re-check. A change of row status from its Stage 19 result, new evidence, or a new risk is referred to the verifier as above before acceptance. A Product Truth conflict or a proposed reclassification goes to the Founder (T7 or T8). Acceptance is not recorded while the check has an unresolved discrepancy.

### Stage 23 — Mission Control Acceptance

- **Owner:** Mission Control with Founder authority where required.
- **Inputs:** Formal Completion Report, the complete evidence chain, and the result of the Reconciliation Integrity Check.
...
- **Output:** The closure package, in this order: (1) confirmation that the acceptance record is merged and canonical `main` is verified; (2) a **draft** closure record with approval date, final commit, deployment reference, follow-up missions, non-blocking issues and repository status, which may be prepared at any time after acceptance together with items (3) to (5) and is marked `DRAFT — NOT EFFECTIVE`; (3) the **OLE disposition**: the learning handoff initiated with its closure-envelope reference, or an explicit no-reusable-learning record with supporting evidence, after which promotion review proceeds inside OLE and does not block closure or the next mission; (4) the **feature-level completion evaluation**: confirmation that the View was updated at Stage 23, and an evaluation of each advanced contract's status independently of mission completion, listing its remaining `BUILD NOW` requirements, because a mission can be `COMPLETED — FORMALLY ACCEPTED` while its feature remains `IMPLEMENTED BUT INCOMPLETE`; (5) the **residual carry-forward**, meaning every row not `DEMONSTRATED` or `NOT APPLICABLE` and every follow-up, recorded with its owning mission so that mission's FCTM inherits it; (6) the **canonical closure decision**: the closure record, which becomes effective as `COMPLETED — FORMALLY ACCEPTED` only when a human merges it, and only after items (3) to (5) are recorded (Gate 11); (7) the communication archive and live reset under the AI Communication and Handover Protocol, after Founder or Mission Control has confirmed closure, which may be carried in the same pull request as the closure decision (verified before that pull request is merged) or follow the merged closure decision; and (8) the update of `mission-control/mission_memory.md`.
- **Approval:** Mission Control.
...
9. Mission Control acceptance before formal documentation closure, with every `IN SCOPE` row `DEMONSTRATED` or covered by a recorded Founder decision, and after the Reconciliation Integrity Check that follows Stage 22.
...
11. The OLE disposition and the residual carry-forward recorded before `COMPLETED — FORMALLY ACCEPTED` becomes effective. Draft closure material may be prepared earlier, and the closure decision is canonical only when a human merges it.
...
| Evidence/report | Reviews | Supports if assigned | Owns only as Evidence and Completion compiler, after independent verification | Not authorized | Supplies evidence | Informed | Evidence and report | Mission Control |
...
| Builder Completion Report | Authorized builder (Lovable unless another builder is named), under its truthful byline | After implementation | Mission Control reviews |
...
| Evidence Package | Evidence and Completion compiler (Claude Code unless another is appointed) | After verification | Mission Control |
| Formal Completion Report (with Experience Verification Matrix and Contract Reconciliation) | Evidence and Completion compiler (Claude Code unless another is appointed) | After independent verification | Mission Control |
| Reconciliation Integrity Check record | Mission Control | After Stage 22 and before Stage 23, recorded in the acceptance record | Mission Control |
...
| 1.1 | 2026-09-18 | Actor-flexibility and Independent Verification Actor amendment (Section 4.9 and related clauses). Merged in PR #598 at `4ddbb647cfb413e43af38a7e362130c5fd16133c`; activated in PR #599 at `fec2ac81a6c5a412ec47cea951b64efe68c66417` | Founder — Riyas PK, under `SB-GOV-IV-1.0` | ACTIVE — AUTHORITATIVE. **Row added retroactively (correction of an omitted entry), see the notes below** |
| 1.2 | 2026-09-19 | Product Mission execution reconciliation: Institutional Learning Intake (Section 3.1); Product Truth Coverage and Traceability (Section 3.2); canonical authority and fail-closed preparation (Section 3.3); Definition Actor; conditional Founder Decision Gate; assembly by reference; Corrective Authorization with mandatory human retest; combined Stage 21 and 22 preparation; Global Product Completion View update at acceptance; expanded closure; Gates 10 and 11; production, migration and delivery boundary (Section 9.1); Stage Ledger. Existing Lovable-specific artifact names retained; Gate 2 unchanged. Independently verified and merged in PR #606 at publication commit `b3cd5f439e8795855d6ef0f527d7ccea18c48080` (publication commit, not an activation commit). Activation preparation merged in PR #607 at preparation commit `86d9813582c4505c41be2c712a2a1df33912e988` (preparation commit, not an activation commit). Activated at the human merge of the finalization pull request (PR #608), activation merge commit `abc458dff590accbc9454367728978553bd3a25b`, `merged_at` 2026-09-20T11:34:43Z UTC | Founder decisions recorded on PR #605 under `SB-GOV-PRODUCT-EXEC-1.0`; Founder human merge of PR #606; Mission Control conditional activation decision (Section 8.1 of the activation record); Founder human merge of PR #608 (the activation event) | ACTIVE — AUTHORITATIVE FROM THE ACTIVATION EVENT (the human merge of the finalization pull request, PR #608, at its actual `merged_at` UTC instant 2026-09-20T11:34:43Z). The activation date and the activation merge commit are recorded here afterward as mandatory factual evidence, and that recording is not a second activation event |

Future refinements must append rather than replace earlier history.

**Correction and interpretation notes (append-only, added under `SB-GOV-PRODUCT-EXEC-1.0`).** The rows above are not rewritten.

1. **Correction — omitted entry.** The v1.1 amendment merged in PR #598 and activated in PR #599 had no row in this log. The v1.1 row is added retroactively and is reconstructed from those pull requests.
2. **Interpretation — status of row 1.0.** The Status of row 1.0 remains as originally logged. Version 1.0 was superseded by Version 1.1 when Version 1.1 was activated on 2026-09-18.
3. **Correction — closing line.** The "Active control" line below originally named Version 1.0 although Version 1.1 was active. It is corrected to name Version 1.1 and to state the pending Version 1.2. The original wording is preserved here: "Source 18 Version 1.0 is Founder approved, active, and authoritative for every `SB-P-*` mission."
4. **Interpretation — header.** The single Approved By, Approval Date and Activation Date lines of the v1.1 header are now written per version. Their v1.0 and v1.1 values are unchanged: Founder — Riyas PK, 2026-09-18 and activation 2026-09-18 for v1.1.
5. **Interpretation — activation-record reconciliation (`SB-GOV-PRODUCT-EXEC-1.0`).** The activation-record pull request updated the v1.2 header fields, the v1.2 row status and the closing line to record that PR #606 was independently verified and merged and that activation is still pending. The Status previously read "AMENDMENT PROPOSED — INDEPENDENT VERIFICATION AND ACTIVATION PENDING", the v1.2 row Status previously read "AMENDMENT PROPOSED — ACTIVATION PENDING", and the closing "Active control" line previously read "Source 18 Version 1.1 is Founder approved, active, and authoritative for every `SB-P-*` mission until Version 1.2 is independently verified, merged and activated by Mission Control. Version 1.2 then becomes the active version." The v1.2 Approved By and Approval Date fields, previously "PENDING", now cite the Founder decisions on PR #605 and the Founder human merge of PR #606 as recorded events. The Activated By and Activation Date fields remain "PENDING". No activation date, activation merge commit or effective-state assertion is recorded, and the rows above for versions 1.0 and 1.1 are unchanged.
6. **Interpretation — Option B activation boundary (`SB-GOV-PRODUCT-EXEC-1.0`).** The activation-record pull request was corrected to follow the Founder's Option B decision (PR #607 comment `5745151886`) and the replacement independent verifier's findings as accepted by Mission Control (PR #607 comment `5748933080`). The header's activation-boundary and Activation Confirmation paragraphs previously described one post-merge step, made of six items, that had to be complete before any amended clause was operative. They defined the Activation Confirmation as a record entered on canonical `main` after the merge of "the activation-record pull request" and after Mission Control had verified the merged `main`, and they did not name PR #607 or distinguish it from a later pull request. They now name PR #607 as preparation only, define a later finalization pull request whose human merge is the single activation event at its actual `merged_at` instant, list what is complete before that event, and require the actual merge commit and time to be recorded afterward as mandatory, append-only factual evidence that is not a second activation event. The Activated By and Activation Date lines previously read "PENDING — set only by the Mission Control Activation Confirmation", and the v1.2 row previously ended "the Activation Confirmation records them". The closing "Active control" line previously read "Source 18 Version 1.1 is Founder approved, active, and authoritative for every `SB-P-*` mission until Mission Control records the Activation Confirmation for Version 1.2. Version 1.2 has been independently verified and merged by a human (PR #606). From the Activation Confirmation, Version 1.2 is the active version." No activation date, merge commit or effective time is recorded, and Version 1.1 remains operative until the activation event.
7. **Interpretation — finalization reconciliation (`SB-GOV-PRODUCT-EXEC-1.0`).** The finalization pull request updated the v1.2 Status, Authority and Activated By lines, the v1.2 row and the Repository publication line to record that Version 1.2 is active from the activation event. The Status previously read "AMENDMENT MERGED (PR #606) — MISSION CONTROL ACTIVATION CONFIRMATION PENDING. v1.2 is not yet operative", the Activated By line previously read "PENDING — set in the finalization pull request defined below, and effective only on its human merge", and the v1.2 row Status previously began "AMENDMENT MERGED (PR #606) — MISSION CONTROL ACTIVATION CONFIRMATION PENDING". The Repository publication line now records the PR #607 preparation commit as a fact and identifies the finalization pull request by its branch. The status of the rows for versions 1.0 and 1.1 remains as logged, and Version 1.1 is superseded by Version 1.2 at the activation event. The Activation Date and the finalization merge commit remain PENDING as mandatory post-merge factual evidence, and no activation date, merge commit or effective time is recorded.
8. **Interpretation — post-activation factual reconciliation (`SB-GOV-PRODUCT-EXEC-1.0`).** The post-activation evidence pull request recorded the activation facts that the finalization pull request had reserved. The Activation Date, previously "PENDING — the `merged_at` UTC date of the finalization pull request, recorded afterward as mandatory factual evidence", now records 2026-09-20T11:34:43Z. The Repository publication line, which previously stated that the merge commit and `merged_at` instant of the finalization pull request "do not yet exist and are not recorded here", now records the PR #608 merge commit `abc458dff590accbc9454367728978553bd3a25b`. The v1.2 row Status previously ended "No activation date or activation merge commit is recorded here. The activation date and the finalization merge commit are recorded afterward as mandatory factual evidence". This reconciliation is mandatory evidence and is not a second activation event. Version 1.2 became active at the human merge of PR #608 at `merged_at` 2026-09-20T11:34:43Z, and that instant is unchanged. The PR #606 publication commit and the PR #607 preparation commit are not activation commits.

---

**Active control:** Source 18 Version 1.1 is Founder approved, active, and authoritative for every `SB-P-*` mission until the activation event defined in the header, which is the human merge of the finalization pull request that carries Mission Control's Activation Confirmation for Version 1.2. Version 1.2 has been independently verified and merged by a human (PR #606). From that merge, at its actual `merged_at` instant, Version 1.2 is the active version and Version 1.1 is superseded. Source 18 remains subordinate to higher-authority constitutional and governance sources.
